...
In Table \ref{Tab:Example12} the solution to these two examples is evaluated with $N = 50$ and compared to the solution evaluated with $N = 10$, $N = 20$ and $N = 30$, using the same error measure as before.
